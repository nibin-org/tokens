        ...
        <div className="ftd-container" style={fontOverrides}>
            <div className="ftd-navbar-sticky">
                <header className="ftd-header">
                    <div className="ftd-header-brand ftd-skeleton-brand">
            ...
            <div className="ftd-navbar-sticky">
                <header className="ftd-header">
                    ...
                    <div className="ftd-header-actions">
                        ...
                        <button className="ftd-header-action-btn" onClick={() => setExportOpen(true)} type="button" title="Export tokens">
                        ...
                        {snapshotEnabled && (
                            <button className="ftd-header-action-btn" onClick={openSnapshotPanel} title="Snapshot history" type="button">
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                        ...
                        {showSearch && (
                            <button className="ftd-header-search-btn" onClick={() => setSearchOpen(true)} title="Search tokens (Cmd+K)" type="button">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                                    <circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/>
                                </svg>
                                <span>Search tokens…</span>
                                <kbd className="ftd-header-kbd">⌘K</kbd>
                            </button>
                        )}
                    </div>
                </header>
